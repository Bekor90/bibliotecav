...
<form id="formEditarCatalogacion" method="post" action="<?=base_url();?>EditarCatalogacion">
	    	 <div class="container">
	           <div class="row">
	        	<div class="col-xs-3 col-md-3">
	    	 		<div class="form-group">						
					  <label for="titulo">Tipo de material</label>
					    <div class="controls">
					     <input class="form-control" type="text" value="<?=$tipo_material?>" name="tipoMaterial" id="tipoMaterial">
						</div>
					</div>
				</div>	
				<div class="col-xs-3 col-md-3">
	    	 		<div class="form-group">						
					  <label for="titulo">Titulo principal</label>
					    <div class="controls">
					     <input class="form-control" type="text" value="<?=$titulo_principal?>" name="tituloPrincipal" id="tituloPrincipal">
						</div>
					</div>
				</div>
				<div class="col-xs-3 col-md-3">
	    	 		<div class="form-group">						
					  <label for="titulo">Titulo secundario</label>
					    <div class="controls">
					     <input class="form-control" type="text" value="<?=$titulo_secundario?>" name="tituloSecundario" id="tituloSecundario">
						</div>
					</div>
				</div>					
	           ...
	           <div class="col-xs-3 col-md-3">
	    	 		<div class="form-group">						
					  <label for="titulo">Fecha de creacion</label>
					    <div class="controls">
					      <input class="form-control" type="date" value="<?=$fecha_creacion?>" name="fechaCreacion" id="fechaCreacion">
						</div>
					</div>
				</div>
				...
				<div class="col-xs-3 col-md-3">
	    	 		<div class="form-group">						
					  <label for="titulo">Fecha de catalogación</label>
					    <div class="controls">
					      <input class="form-control" type="date" value="<?=$fecha_catalogacion?>" name="fechaCatalogacion" id="fechaCatalogacion">
						</div>
					</div>
				</div>
				<div class="col-xs-3 col-md-3">
						...
						<label for="areas">Palabras clave</label>
				 		 <div class="controls">										
						   <select  class="form-control" name="palabras" id="palabras">
						    <option value="<?=$nombre_palabra?>"><?=$nombre_palabra?></option>
						...
						<label for="areas">Autores</label>
				 		 <div class="controls">										
						   <select  class="form-control" name="autores" id="autores">
						    <option value="<?=$apellido_autor?>"><?=$apellido_autor?></option>
			...
			<div class="col-xs-3 col-md-3">
    	 		<div class="form-group">						
				  <label for="titulo">Editorial</label>
				    <div class="controls">
				      <input class="form-control" type="text" value="<?=$editorial?>" name="editorial" id="editorial">
					</div>
				</div>
			</div>
			<div class="col-xs-3 col-md-3">
